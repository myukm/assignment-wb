...
public class Constants {
    ...
    public static String WALLETHUB_REVIEWS_URL = "http://wallethub.com/profile/test_insurance_company/";
    public static int REVIEW_STARS = 4;
    public static String REVIEW_DRP_DOWN_ITEM = "Health Insurance";

    //WEB ELEMENTS XPATH
    public static int TAB_COUNT_POST_MESSAGE = 10;
